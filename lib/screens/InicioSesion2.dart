  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (res.session != null && res.user != null) {
        ...
        final ayudanteData = await supabase
            .from('personas_apoyo')
            .select('id')
            .eq('id', userId)
            .maybeSingle();
        ...
        if (ayudanteData != null) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (_) => const TrabajadorShell()),
          );
          return;
        }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Acceda a su terminal operativa',
                            style: TextStyle(
                              fontSize: 13,
                          ...
                          Center(
                            child: TextButton(
                              onPressed: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => const RegistroOrganizacion(),
                                ),
                              ),
                              child: const Text(
                                'Registrar Institución / Organización',
                                style: TextStyle(
                                  fontSize: 11,
                                  color: AppColors.textLight,
                                ),
